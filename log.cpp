...
void Log::Trace(const std::string& msg){LOG4CPLUS_TRACE(logger, tstring(msg.begin(), msg.end()));}
void Log::Debug(const std::string& msg){LOG4CPLUS_DEBUG(logger, tstring(msg.begin(), msg.end()));}
void Log::Info(const std::string& msg){LOG4CPLUS_INFO(logger, tstring(msg.begin(), msg.end()));}
void Log::Warn(const std::string& msg){LOG4CPLUS_WARN(logger, tstring(msg.begin(), msg.end()));}
void Log::Error(const std::string& msg){LOG4CPLUS_ERROR(logger, tstring(msg.begin(), msg.end()));}
void Log::Fatal(const std::string& msg){LOG4CPLUS_FATAL(logger, tstring(msg.begin(), msg.end()));}